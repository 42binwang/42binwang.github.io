...
! function(t, e) {
  ...
  function n(e, r, o) {
    return function(i, a) {
      var s = e + i;
      return a ? void a(n(s, r, o)) : new t(e + i, r, o)
    }
  }

  function r(t, e, n) {
    for (var r = 0, o = 0, i = t.length; i > o; o++) r += t[o].path.length;
    e = e.substr(r);
    var a = {
      path: e,
      handler: n
  ...
  function o(t, e, n, i) {
    ...
    for (var s in a)
      if (a.hasOwnProperty(s)) {
        var h = t.slice();
        r(h, s, a[s]), e.children[s] ? o(h, e.children[s], n, i) : n.call(i, h)
      }
  }

  function i(t, r) {
    var i = new e;
    t(n("", i, this.delegate)), o([], i, function(t) {
  ...
  function l(t, e, n) {
    ...
    for (var i = 0, a = r.length; a > i; i++) {
      var l, p = r[i];
      (l = p.match(/^:([^\/]+)$/)) ? (o.push(new h(l[1])), e.push(l[1]), n.val += "3") : (l = p.match(/^\*([^\/]+)$/)) ? (o.push(new c(l[1])), n.val += "2", e.push(l[1])) : "" === p ? (o.push(new u), n.val += "1") : (o.push(new s(p)), n.val += "4")
    }
  ...
  function g(t, e, n) {
    for (var r = t.handlers, o = t.regex, i = e.match(o), a = 1, s = new v(n), h = 0, c = r.length; c > h; h++) {
      for (var u = r[h], l = u.names, p = {}, f = 0, d = l.length; d > f; f++) p[l[f]] = i[a++];
      s.push({
        handler: u.handler,
        params: p,
        isDynamic: !!l.length
  ...
  function R(t, e) {
    U ? U.$options.components._ = t.component : U = {
      resolve: N.Vue.prototype._resolveComponent,
      $options: {
        components: {
          _: t.component
        }
      }
    }, U.resolve("_", function(n) {
      t.component = n, e(n)
    })
  }
  ...
  function x(t, e, n) {
    return void 0 === e && (e = {}), t = t.replace(/:([^\/]+)/g, function(n, r) {
      var o = e[r];
      return o || _('param "' + r + '" not found when generating path for "' + t + '" with params ' + JSON.stringify(e)), o || ""
    }), n && (t += I(n)), t
  }
  ...
  function $(t, e, n) {
    ...
    var o = C(r, "canReuse");
    return "boolean" == typeof o ? o : o ? o.call(r, {
      to: n.to,
      from: n.from
    }) : !0
  }
  ...
  function k(t, e, n) {
    var r = t.childVM,
      o = C(r, "deactivate");
    o ? e.callHooks(o, r, n) : n()
  }

  function S(t, e, n, r, o) {
    var i = e.activateQueue[n];
    if (!i) return t._bound && t.setComponent(null), void(r && r());
    var a = t.Component = i.component,
      s = C(a, "activate"),
      h = C(a, "data"),
      c = C(a, "waitForData");
    ...
    var u = void 0,
      l = !(!h || c);
    if (o = o && t.childVM && t.childVM.constructor === a) u = t.childVM, u.$loadingRouteData = l;
    else {
      if (t.unbuild(!0), t.keepAlive) {
        var p = e.router._views,
          f = p.indexOf(t);
        f > 0 && (e.router._views = p.slice(f), t.childVM && (t.childVM._routerViews = p.slice(0, f)))
      }
      if (u = t.build({
          _meta: {
            $loadingRouteData: l
        ...
        var d = u._routerViews;
        d && (e.router._views = d.concat(e.router._views), t.childView = d[d.length - 1], u._routerViews = null)
      }
    }
    var v = function() {
        u.$destroy()
  ...
  function V(t, e, n, r, o) {
    t.$loadingRouteData = !0, e.callHooks(n, t, function(e, n) {
      Array.isArray(e) && e._needMerge && (e = e.reduce(function(t, e) {
        return O(e) && Object.keys(e).forEach(function(n) {
          t[n] = e[n]
        }), t
      }, Object.create(null)));
      var o = [];
  ...
  function j(t) {
    ...
    t.prototype._init = function(t) {
      var r = t._parent || t.parent || this,
        o = r.$route;
      o && (o.router._children.push(this), this.$route || (this._defineMeta ? this._defineMeta("$route", o) : e.defineReactive(this, "$route", o))), n.call(this, t)
    };
    var r = t.prototype._destroy;
    t.prototype._destroy = function() {
      if (!this._isBeingDestroyed) {
        var t = this.$root.$route;
        t && t.router._children.$remove(this), r.apply(this, arguments)
      }
    };
    var o = t.config.optionMergeStrategies,
      i = /^(data|activate|deactivate)$/;
    o && (o.route = function(t, n) {
      if (!n) return t;
      if (!t) return n;
      var r = {};
      e.extend(r, t);
      for (var o in n) {
        var a = r[o],
          s = n[o];
        a && i.test(o) ? r[o] = (e.isArray(a) ? a : [a]).concat(s) : r[o] = s
      }
      return r
    })
  }
  ...
  function H(t) {
    ...
    e.extend(r, {
      ...
      bind: function() {
        ...
        var e = this.router = t.router;
        e._views.unshift(this);
        var r = e._views[1];
        r && (r.childView = this);
        var o = t.router._currentTransition;
        if (!r && o.done || r && r.activated) {
          var i = r ? r.depth + 1 : 0;
          S(this, o, i)
        }
      },
  ...
  function q(t) {
    ...
    t.directive("link", {
      bind: function() {
        var t = this,
          r = this.vm;
        if (!r.$route) return void _("v-link can only be used inside a router-enabled app.");
        if ("A" !== this.el.tagName || "_blank" !== this.el.getAttribute("target")) {
          var o = r.$route.router;
          this.handler = function(n) {
            if (!(n.metaKey || n.ctrlKey || n.shiftKey || n.defaultPrevented || 0 !== n.button)) {
              ...
              if ("A" === t.el.tagName || n.target === t.el) i(r);
              else {
                for (var a = n.target; a && "A" !== a.tagName && a !== t.el;) a = a.parentNode;
                if (!a) return;
                "A" === a.tagName && a.href ? e(a) && i({
                  path: a.pathname,
                  replace: r && r.replace,
                  append: r && r.append
                }) : i(r)
      ...
      update: function(t) {
        var e = this.vm.$route.router,
          r = void 0;
        this.target = t, n.isObject(t) && (r = t.append, this.exact = t.exact, this.prevActiveClass = this.activeClass, this.activeClass = t.activeClass), t = this.path = e._stringifyPath(t), this.activeRE = t && !this.exact ? new RegExp("^" + t.replace(/\/$/, "").replace(tt, "\\$&") + "(\\/|$)") : null, this.updateClasses(this.vm.$route.path);
        var o = "/" === t.charAt(0),
          i = t && ("hash" === e.mode || o) ? e.history.formatPath(t, r) : t;
        "A" === this.el.tagName && (i ? this.el.href = i : this.el.removeAttribute("href"))
      },
      updateClasses: function(t) {
        var e = this.el,
          r = this.vm.$route.router,
          o = this.activeClass || r._linkActiveClass;
        this.prevActiveClass !== o && n.removeClass(e, this.prevActiveClass);
        var i = this.path.replace(et, "");
        t = t.replace(et, ""), this.exact ? i === t || "/" !== i.charAt(i.length - 1) && i === t.replace(Z, "") ? n.addClass(e, o) : n.removeClass(e, o) : this.activeRE && this.activeRE.test(t) ? n.addClass(e, o) : n.removeClass(e, o)
      },
      unbind: function() {
  ...
  function Q(t, e) {
    var n = e.component;
    rt.util.isPlainObject(n) && (n = e.component = rt.extend(n)), "function" != typeof n && (e.component = null, _('invalid component for route "' + t + '".'))
  }
  var D = {};
  D.classCallCheck = function(t, e) {
    ...
    addChild: function(t, r, o, i) {
      var a = new e(r);
      this.children[t] = a;
      var s = n(t, a, i);
      i && i.contextEntered && i.contextEntered(r, s), o(s)
    }
  };
  var M = ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\"],
    z = new RegExp("(\\" + M.join("|\\") + ")", "g");
  s.prototype = {
    eachChar: function(t) {
      for (var e, n = this.string, r = 0, o = n.length; o > r; r++) e = n.charAt(r), t({
        validChars: e
      })
    },
    regex: function() {
    ...
    get: function(t) {
      for (var e = this.nextStates, n = 0, r = e.length; r > n; n++) {
        var o = e[n],
          i = o.charSpec.validChars === t.validChars;
        if (i = i && o.charSpec.invalidChars === t.invalidChars) return o
      }
    },
    put: function(t) {
      var e;
    ...
    match: function(t) {
      for (var e, n, r, o = this.nextStates, i = [], a = 0, s = o.length; s > a; a++) e = o[a], n = e.charSpec, "undefined" != typeof(r = n.validChars) ? -1 !== r.indexOf(t) && i.push(e) : "undefined" != typeof(r = n.invalidChars) && -1 === r.indexOf(t) && i.push(e);
      return i
    }
  };
  ...
  L.prototype = {
    add: function(t, e) {
      ...
      h && (r = r.put({
        validChars: "/"
      }), o += "/"), r.handlers = a, r.regex = new RegExp(o + "$"), r.specificity = i, (n = e && e.as) && (this.names[n] = {
        segments: s,
        handlers: a
      })
    },
    handlersFor: function(t) {
      ...
      for (var r = 0, o = e.handlers.length; o > r; r++) n.push(e.handlers[r]);
      return n
    },
    hasRoute: function(t) {
      return !!this.names[t]
    ...
    generate: function(t, e) {
      ...
      for (var o = n.segments, i = 0, a = o.length; a > i; i++) {
        var s = o[i];
    ...
    parseQueryString: function(t) {
      for (var e = t.split("&"), n = {}, r = 0; r < e.length; r++) {
        var o, i = e[r].split("="),
          ...
          s = a.length,
          h = !1;
        1 === i.length ? o = "true" : (s > 2 && "[]" === a.slice(s - 2) && (h = !0, a = a.slice(0, s - 2), n[a] || (n[a] = [])), o = i[1] ? m(i[1]) : ""), h ? n[a].push(o) : n[a] = o
      }
      return n
    },
    recognize: function(t) {
      var e, n, r, o, i = [this.rootState],
        a = {},
        s = !1;
      if (o = t.indexOf("?"), -1 !== o) {
        var h = t.substr(o + 1, t.length);
        t = t.substr(0, o), a = this.parseQueryString(h)
      }
      for (t = decodeURI(t), "/" !== t.charAt(0) && (t = "/" + t), e = t.length, e > 1 && "/" === t.charAt(e - 1) && (t = t.substr(0, e - 1), s = !0), n = 0, r = t.length; r > n && (i = d(i, t.charAt(n)), i.length); n++);
      var c = [];
      for (n = 0, r = i.length; r > n; n++) i[n].handlers && c.push(i[n]);
      i = f(c);
      var u = c[0];
      return u && u.handlers ? (s && "(.+)$" === u.regex.source.slice(-5) && (t += "/"), g(u, t, a)) : void 0
    }
  }, L.prototype.map = i, L.VERSION = "0.1.9";
  var I = L.prototype.generateQueryString,
    N = {},
    U = void 0,
    B = /#.*$/,
    G = function() {
      function t(e) {
        var n = e.root,
          r = e.onChange;
        D.classCallCheck(this, t), n ? ("/" !== n.charAt(0) && (n = "/" + n), this.root = n.replace(/\/$/, ""), this.rootRE = new RegExp("^\\" + this.root)) : this.root = null, this.onChange = r;
      ...
      return t.prototype.start = function() {
        ...
        var o = t.match(B),
          i = o && o[0];
        t = r.replace(B, "").replace(this.rootRE, ""), this.onChange(t, null, i)
    ...
    K = function() {
      function t(e) {
        var n = e.hashbang,
          r = e.onChange;
        D.classCallCheck(this, t), this.hashbang = n, this.onChange = r
      }
      return t.prototype.start = function() {
        var t = this;
        this.listener = function() {
          ...
          t.onChange(decodeURI(e.replace(/^#!?/, "") + o))
    ...
    X = function() {
      function t(e) {
        var n = e.onChange;
        D.classCallCheck(this, t), this.onChange = n, this.currentPath = "/"
      }
      return t.prototype.start = function() {
        this.onChange("/")
    ...
    Y = function() {
      function t(e, n, r) {
        D.classCallCheck(this, t), this.router = e, this.to = n, this.from = r, this.next = null, this.aborted = !1, this.done = !1, this.deactivateQueue = e._views;
        var o = n.matched ? Array.prototype.slice.call(n.matched) : [];
        this.activateQueue = o.map(function(t) {
          return t.handler
        })
      }
      return t.prototype.abort = function() {
        ...
        var e = this,
          ...
          i = void 0,
          a = void 0;
        for (a = 0; a < o.length && $(o[a], r[a], e); a++);
        a > 0 && (i = o.slice(0, a), n = o.slice(a).reverse(), r = r.slice(a)), e.runQueue(n, A, function() {
        ...
        var y = b(v);
        i ? "boolean" == typeof v ? v ? f() : l() : y ? v.then(function(t) {
          t ? f() : l()
    ...
    W = function it(t, e) {
      var n = this;
      D.classCallCheck(this, it);
      var r = e._recognizer.recognize(t);
      r && ([].forEach.call(r, function(t) {
        for (var e in t.handler) J.test(e) || (n[e] = t.handler[e])
    ...
    ot = function() {
      function t() {
        ...
        if (D.classCallCheck(this, t), !t.installed) throw new Error("Please install the Router with Vue.use() before creating an instance.");
        this.app = null, this._views = [], this._children = [], this._recognizer = new L, this._guardRecognizer = new L, this._started = !1, this._startCb = null, this._currentRoute = {}, this._currentTransition = null, this._previousTransition = null, this._notFoundHandler = null, this._notFoundRedirect = null, this._beforeEachHooks = [], this._afterEachHooks = [], this._hasPushState = "undefined" != typeof window && window.history && window.history.pushState, this._rendered = !1, this._transitionOnLoad = l, this._abstract = i, this._hashbang = r, this._history = this._hasPushState && s, this._saveScrollPosition = c, this._linkActiveClass = y, this._suppress = f;
        var m = rt.util.inBrowser;
        this.mode = !m || this._abstract ? "abstract" : this._history ? "html5" : "hash";
        var _ = nt[this.mode],
          w = this;
        this.history = new _({
          root: v,
      ...
      return t.prototype.map = function(t) {
        ...
        var e = !1,
          n = !1;
        rt.util.isObject(t) && (e = t.replace, n = t.append), t = this._stringifyPath(t), t && this.history.go(t, e, n)
        ...
        if (this._started = !0, this._startCb = n, !this.app) {
          ...
          var r = this._appConstructor = "function" == typeof t ? t : rt.extend(t);
        ...
        if (!this._checkGuard(t)) {
          ...
          if (i) {
            if (i.to.path === t) return;
            if (o.path === t) return i.aborted = !0, void(this._currentTransition = this._prevTransition);
            i.aborted = !0
          }
          var a = new W(t, this),
            s = new Y(this, a, o);
          this._prevTransition = i, this._currentTransition = s, this.app || (this.app = new this._appConstructor({
        ...
        var r = e && e.pos;
        r && this._saveScrollPosition ? rt.nextTick(function() {
        ...
        if (t && "object" == typeof t) {
          if (t.name) {
            var e = t.params || {};
            return t.query && (e.queryParams = t.query), this._recognizer.generate(t.name, e)
          }
          if (t.path) {
            var n = t.path;
            if (t.query) {
              var r = this._recognizer.generateQueryString(t.query);
              n += n.indexOf("?") > -1 ? "&" + r.slice(1) : r
            }
            return n
          }
          return ""
